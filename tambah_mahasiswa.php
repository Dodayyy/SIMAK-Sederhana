            ...
            <div class="container-xl">
                ...
                <div class="card">
                    <div class="card-header card text-white" style="background-color: #15a362">
                        <h1 class="h4 mb-0 text-gray-100 text-white">Form Tambah Data Mahasiswa</h1>
                    </div>
                    <div class=" card-body">
                        <form action="simpan_mahasiswa.php" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="txtnama">
                            </div>
