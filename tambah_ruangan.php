            ...
            <div class="container-xl">
                ...
                <div class="card">
                    <div class="card-header card text-white" style="background-color: #15a362">
                        <h1 class="h4 mb-0 text-gray-100 text-white">Form Tambah Data Ruangan</h1>
                    </div>
                    <div class=" card-body">
                        <form action="simpan_ruangan.php" method="POST">
                            <div class="mb-3">
                                <label for="exampleInputEmail1" class="form-label">ID Ruangan</label>
                                <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="auto increment" name="id_ruangan" readonly>
                            </div>

                            <div class="mb-3">
                                <label for="exampleInputEmail1" class="form-label">Nama Ruangan</label>
                                <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="nama_ruangan">
                            </div>

                            <div class="mb-3">
                                <label for="exampleInputEmail1" class="form-label">Kapasitas Ruangan</label>
                                <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="kapasitas">
                            </div>

                            <div class="mb-3">
                                <label for="exampleInputEmail1" class="form-label">Lantai</label>
                                <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="lantai">
                            </div>
