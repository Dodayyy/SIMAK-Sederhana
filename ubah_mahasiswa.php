            ...
            <div class="container-xl">
                ...
                <div class="card">
                    <div class="card-header card text-white" style="background-color: #15a362">
                        <h1 class="h4 mb-0 text-gray-100 text-white">Form Ubah Data Mahasiswa</h1>
                    </div>
                    <div class="card-body">
                        <form action="update_mahasiswa.php" method="POST">
                            <div class="mb-3">
                                <label for="exampleInputEmail1" class="form-label">NIM</label>
                                <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="<?php echo $isi['nim']; ?>" name="txtnim" readonly>
                            </div>

                            <div class="mb-3">
                                <label for="exampleInputEmail1" class="form-label">Nama</label>
                                <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="<?php echo $isi['nama']; ?>" name="txtnama">
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" aria-label="Default select example" name="kelas">
                                    <option value="<?php echo $isi['kelas']; ?>"><?php echo $isi['kelas']; ?></option>
                                    <option value="4TI-A">4TI-A</option>
                                    <option value="4TI-B">4TI-B</option>
                                    <option value="4TI-C">4TI-C</option>
                                </select>
                            </div>
